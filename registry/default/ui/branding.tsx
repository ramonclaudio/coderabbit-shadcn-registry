...
const ICON_DARK = '/coderabbit/coderabbit-dark-icon.svg'
const ICON_LIGHT = '/coderabbit/coderabbit-light-icon.svg'
const LOGO_DARK = '/coderabbit/coderabbit-dark-logo.svg'
const LOGO_LIGHT = '/coderabbit/coderabbit-light-logo.svg'
